...
Также настроим политики блокировки учетной записи, при неправильном вводе пароля.
\begin{figure}[H]
  \centering
...
Также создадим в каждом подразделении сетевой ресурс, указывающий на общую папку.
\begin{figure}[H]
  \centering
